...
import svgPaths from "./svg-xwqddryv9o";
...
export default function ShoppingCartEmpty() {
  return (
    <div className="bg-white relative size-full" data-name="Shopping Cart - Empty">
      <div className="absolute bg-[#fffbf0] content-stretch flex flex-col h-[730.4px] items-start left-0 pt-[118.4px] top-0 w-[1512.8px]" data-name="$c">
        <div className="bg-[#fffbf0] h-[730.4px] relative shrink-0 w-[1512.8px]" data-name="Dd">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pl-[590.663px] pr-[590.675px] relative size-full">
            <BackgroundImage2 additionalClassNames="h-[284px] w-[331.462px]">
              <div className="absolute left-[117.72px] size-[96px] top-0" data-name="Icon">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 96 96">
                  <g id="Icon">
                    <path d={svgPaths.p3fe0a700} id="Vector" stroke="url(#paint0_linear_1_3109)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" />
                    <path d="M12 24H84" id="Vector_2" stroke="url(#paint1_linear_1_3109)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" />
                    <path d={svgPaths.p1ac1fb80} id="Vector_3" stroke="var(--stroke-0, #F14749)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" />
                  </g>
                  <defs>
                    <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_3109" x1="48" x2="48" y1="8" y2="88">
                      <stop stopColor="#E4550C" />
                      <stop offset="1" stopColor="#FE3A86" />
                    </linearGradient>
                    <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_3109" x1="12" x2="84" y1="24.5" y2="24.5">
              ...
              <div className="absolute h-[36px] left-0 top-[120px] w-[331.462px]" data-name="Heading 2">
                <p className="-translate-x-1/2 absolute font-['Playfair_Display:Bold',sans-serif] font-bold leading-[36px] left-[166.02px] text-[#2d2d2d] text-[30px] text-center top-[-0.4px] whitespace-nowrap">Your Cart is Empty</p>
              </div>
              <div className="absolute h-[24px] left-0 top-[172px] w-[331.462px]" data-name="Paragraph">
                <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[24px] left-[166px] text-[#4a5565] text-[16px] text-center top-[-0.4px] whitespace-nowrap">Add some beautiful products to get started!</p>
              </div>
              <div className="absolute bg-[#ff1a75] h-[56px] left-[45.1px] rounded-[26843500px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[228px] w-[241.25px]" data-name="Link">
                <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] left-[107px] text-[16px] text-center text-white top-[15.6px] whitespace-nowrap">Continue Shopping</p>
                <IconBackgroundImage additionalClassNames="absolute left-[189.25px] top-[18px]">
      ...
      <div className="absolute bg-white border-[rgba(255,102,178,0.2)] border-b-[0.8px] border-solid h-[118.4px] left-0 top-0 w-[1512.8px]" data-name="Ic">
        ...
        <div className="absolute h-[49.6px] left-[68.4px] top-[52px] w-[1376px]" data-name="Container">
          ...
          <div className="absolute h-[40px] left-[1070.18px] top-[4.8px] w-[305.825px]" data-name="Container">
            ...
            <button className="absolute bg-[#ff1a75] content-stretch cursor-pointer flex gap-[8px] h-[40px] items-center left-[212.3px] px-[16px] rounded-[26843500px] top-0 w-[93.525px]" data-name="Link">
              ...
              <div className="flex-[1_0_0] h-[24px] min-h-px min-w-px relative" data-name="Ic">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                  <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[24px] left-0 text-[16px] text-left text-white top-[-0.4px] whitespace-nowrap">Cart</p>
                </div>
              </div>
            </button>
          </div>
