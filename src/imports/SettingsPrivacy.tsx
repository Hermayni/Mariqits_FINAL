...
import svgPaths from "./svg-anbnkxcdx3";
...
function ButtonBackgroundImage({ children, additionalClassNames = "" }: React.PropsWithChildren<ButtonBackgroundImageProps>) {
  return (
    <div className={clsx("h-[48px] relative rounded-[16px] shrink-0 w-full", additionalClassNames)}>
...
function ContainerBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="bg-[#fff0f8] h-[76px] relative rounded-[16px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
...
function ParagraphBackgroundImageAndText1({ text }: ParagraphBackgroundImageAndText1Props) {
  return (
    <div className="h-[24px] relative shrink-0 w-full">
      <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[24px] left-0 text-[#2d2d2d] text-[16px] top-[-0.4px] whitespace-nowrap">{text}</p>
    </div>
  );
}
...
export default function SettingsPrivacy() {
  return (
    <div className="bg-white relative size-full" data-name="Settings & Privacy">
      <div className="absolute bg-[#fff8c3] content-stretch flex flex-col h-[730.4px] items-start left-0 pt-[118.4px] top-0 w-[1512.8px]" data-name="$c">
        <div className="bg-[#fffbf0] h-[1156.787px] relative shrink-0 w-[1512.8px]" data-name="Ed">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[32px] items-start pt-[48px] px-[68.4px] relative size-full">
            <div className="h-[160px] relative rounded-[24px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-full" data-name="Container" style={{ backgroundImage: "linear-gradient(96.6325deg, rgb(234, 97, 125) 0%, rgb(253, 212, 113) 99.968%)" }}>
                  ...
                  <div className="h-[72px] relative shrink-0 w-[483.925px]" data-name="Container">
                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative size-full">
                      <div className="h-[40px] relative shrink-0 w-full" data-name="Heading 1">
                        <p className="absolute font-['IM_FELL_DW_Pica:Italic',sans-serif] italic leading-[40px] left-0 text-[36px] text-white top-0 whitespace-nowrap">Welcome back, Maria Santos!</p>
                      </div>
            ...
            <div className="h-[868.788px] relative shrink-0 w-full" data-name="Container">
              <div className="absolute h-[868.788px] left-0 top-0 w-[320px]" data-name="Container" />
              <div className="absolute content-stretch flex flex-col gap-[24px] h-[868.788px] items-start left-[352px] top-0 w-[1024px]" data-name="Container">
                <div className="bg-white h-[289.587px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
                  ...
                  <div className="content-stretch flex flex-col gap-[24px] items-start pb-[0.8px] pt-[32.8px] px-[32.8px] relative size-full">
                    <div className="content-stretch flex h-[31.988px] items-start relative shrink-0 w-full" data-name="Heading 2">
                      <p className="flex-[1_0_0] font-['Playfair_Display:Bold',sans-serif] font-bold leading-[32px] min-h-px min-w-px relative text-[#2d2d2d] text-[24px]">Security Settings</p>
                    </div>
                    <div className="content-stretch flex flex-col gap-[16px] h-[168px] items-start relative shrink-0 w-full" data-name="Container">
                      <ContainerBackgroundImage>
                        <ContainerBackgroundImage2 additionalClassNames="w-[182.525px]">
                          <ParagraphBackgroundImageAndText text="Password" />
                          <BackgroundImageAndText text="Last changed 2 months ago" />
                        </ContainerBackgroundImage2>
                        <div className="bg-[#ff1a75] h-[40px] relative rounded-[26843500px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] shrink-0 w-[186.3px]" data-name="Button">
                          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                            <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[24px] left-[93.5px] text-[16px] text-center text-white top-[7.6px] whitespace-nowrap">Change Password</p>
                          </div>
                        </div>
                      </ContainerBackgroundImage>
                      <ContainerBackgroundImage>
                        <ContainerBackgroundImage2 additionalClassNames="w-[208.8px]">
                          <ParagraphBackgroundImageAndText text="Two-Factor Authentication" />
                          <BackgroundImageAndText text="Add an extra layer of security" />
                        </ContainerBackgroundImage2>
                        <div className="h-[43.2px] relative rounded-[26843500px] shrink-0 w-[103.7px]" data-name="Button">
                          <div aria-hidden="true" className="absolute border-[#ff1a75] border-[1.6px] border-solid inset-0 pointer-events-none rounded-[26843500px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]" />
                          <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                            <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[24px] left-[52.1px] text-[#ff1a75] text-[16px] text-center top-[9.2px] whitespace-nowrap">Enable</p>
                          </div>
                        </div>
                      </ContainerBackgroundImage>
                    </div>
                ...
                <div className="bg-white h-[345.6px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
                  <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(255,102,178,0.2)] border-solid inset-0 pointer-events-none rounded-[16px]" />
                  <div className="content-stretch flex flex-col gap-[16px] items-start pb-[0.8px] pt-[32.8px] px-[32.8px] relative size-full">
                    <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 3">
                      <p className="absolute font-['Playfair_Display:Bold',sans-serif] font-bold leading-[28px] left-0 text-[#2d2d2d] text-[20px] top-[0.8px] whitespace-nowrap">Privacy Settings</p>
                    </div>
                    <div className="content-stretch flex flex-col gap-[16px] h-[236px] items-start relative shrink-0 w-full" data-name="Container">
                      <ContainerBackgroundImage1 additionalClassNames="h-[68px]">
                        <ContainerBackgroundImage2 additionalClassNames="w-[307.438px]">
                          <ParagraphBackgroundImageAndText1 text="Email Notifications" />
                          <BackgroundImageAndText text="Receive updates about orders and promotions" />
                        </ContainerBackgroundImage2>
                        <div className="h-[24px] shrink-0 w-[48px]" data-name="Checkbox" />
                      </ContainerBackgroundImage1>
                      <ContainerBackgroundImage1 additionalClassNames="h-[68px]">
                        <ContainerBackgroundImage2 additionalClassNames="w-[235.262px]">
                          <ParagraphBackgroundImageAndText1 text="SMS Notifications" />
                          <BackgroundImageAndText text="Get order updates via text message" />
                        </ContainerBackgroundImage2>
                        <div className="h-[24px] shrink-0 w-[48px]" data-name="Checkbox" />
                      </ContainerBackgroundImage1>
                      <ContainerBackgroundImage1 additionalClassNames="h-[68px]">
                        <ContainerBackgroundImage2 additionalClassNames="w-[370.837px]">
                          <ParagraphBackgroundImageAndText1 text="Marketing Communications" />
                          <BackgroundImageAndText text="Receive special offers and new product announcements" />
                        </ContainerBackgroundImage2>
                        <div className="h-[24px] shrink-0 w-[48px]" data-name="Checkbox" />
                      </ContainerBackgroundImage1>
                    </div>
                ...
                <div className="bg-[#fef2f2] h-[185.6px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
                  <div aria-hidden="true" className="absolute border-[#ffc9c9] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[16px]" />
                  <div className="absolute h-[28px] left-[32.8px] top-[32.8px] w-[958.4px]" data-name="Heading 3">
                    <p className="absolute font-['Playfair_Display:Bold',sans-serif] font-bold leading-[28px] left-0 text-[#82181a] text-[20px] top-[0.8px] whitespace-nowrap">Danger Zone</p>
                  </div>
                  <div className="absolute h-[20px] left-[32.8px] top-[68.8px] w-[958.4px]" data-name="Paragraph">
                    <p className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#c10007] text-[14px] top-[-0.2px] whitespace-nowrap">Once you delete your account, there is no going back. Please be certain.</p>
                  </div>
                  <div className="absolute bg-[#e7000b] h-[48px] left-[32.8px] rounded-[26843500px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[104.8px] w-[168.15px]" data-name="Button">
                    <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] left-[84.5px] text-[16px] text-center text-white top-[11.6px] whitespace-nowrap">Delete Account</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="absolute bg-white content-stretch flex flex-col gap-[24px] h-[306.4px] items-start left-[68.4px] pb-[0.8px] pt-[24.8px] px-[24.8px] rounded-[16px] top-[358.4px] w-[320px]" data-name="Ed">
        <div aria-hidden="true" className="absolute border-[0.8px] border-[rgba(255,102,178,0.2)] border-solid inset-0 pointer-events-none rounded-[16px]" />
        <div className="content-stretch flex flex-col gap-[8px] h-[160px] items-start relative shrink-0 w-full" data-name="Navigation">
          <ButtonBackgroundImage>
            ...
            <BackgroundImage2 additionalClassNames="w-[49.263px]">
              <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[24px] left-[25px] text-[#364153] text-[16px] text-center top-[-0.4px] whitespace-nowrap">Profile</p>
            </BackgroundImage2>
          </ButtonBackgroundImage>
          <ButtonBackgroundImage>
            <IconBackgroundImage additionalClassNames="relative shrink-0">
            ...
            <BackgroundImage2 additionalClassNames="w-[79.25px]">
          ...
          <ButtonBackgroundImage additionalClassNames="bg-[#ff1a75] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)]">
            <IconBackgroundImage additionalClassNames="relative shrink-0">
              <path d={svgPaths.p2566d000} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              <path d={svgPaths.p1bf79e00} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
            </IconBackgroundImage>
            <BackgroundImage2 additionalClassNames="w-[136.887px]">
              <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[24px] left-[68.5px] text-[16px] text-center text-white top-[-0.4px] whitespace-nowrap">{`Security & Privacy`}</p>
            </BackgroundImage2>
          </ButtonBackgroundImage>
        </div>
        ...
        <div className="h-[355.8px] relative shrink-0 w-full" data-name="Container">
          <div className="content-stretch flex flex-col gap-[32px] items-start pt-[48px] px-[32px] relative size-full">
            ...
            <div className="content-stretch flex flex-col h-[52.8px] items-start pt-[32.8px] relative shrink-0 w-full" data-name="Container">
              <div aria-hidden="true" className="absolute border-[rgba(255,102,178,0.2)] border-solid border-t-[0.8px] inset-0 pointer-events-none" />
              <ContainerBackgroundImage1 additionalClassNames="h-[20px]">
