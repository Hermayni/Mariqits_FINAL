...
import svgPaths from "./svg-gpylipp5vg";
import imgScreenshot202603180112382 from "figma:asset/5ddf44f50451b9bf927c871e307b11bf328c188a.png";
...
function ButtonBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="h-[32px] relative shrink-0 w-[40px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[8px] px-[12px] relative size-full">{children}</div>
    </div>
  );
}
    ...
    <div className="absolute bottom-1/2 left-[20.83%] right-[20.83%] top-1/2">
      <div className="absolute inset-[-0.67px_-7.14%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6667 1.33333">
          <path d="M0.666667 0.666667H10" id="Vector" stroke="var(--stroke-0, #FF1A75)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </svg>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white relative size-full" data-name="Shopping Cart">
      <div className="absolute bg-[#fffbf0] content-stretch flex flex-col h-[730.4px] items-start left-0 pt-[118.4px] top-0 w-[1512.8px]" data-name="$c">
        <div className="bg-[#fffbf0] h-[730.4px] relative shrink-0 w-[1512.8px]" data-name="Dd">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[32px] items-start pt-[48px] px-[68.4px] relative size-full">
            <div className="content-stretch flex flex-col gap-[8px] h-[72px] items-start relative shrink-0 w-full" data-name="Container">
              <div className="h-[40px] relative shrink-0 w-full" data-name="Heading 1">
                <p className="absolute font-['IM_FELL_DW_Pica:Italic',sans-serif] italic leading-[40px] left-0 text-[#2d2d2d] text-[36px] top-0 whitespace-nowrap">Shopping Cart</p>
              </div>
              <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
                <p className="absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[24px] left-0 text-[#4a5565] text-[16px] top-[-0.4px] whitespace-nowrap">1 item in your cart</p>
              </div>
            </div>
            <div className="h-[508.788px] relative shrink-0 w-full" data-name="Container">
              <div className="absolute bg-white content-stretch flex flex-col h-[177.6px] items-start left-0 pb-[0.8px] pt-[24.8px] px-[24.8px] rounded-[16px] top-0 w-[906.663px]" data-name="Container">
                ...
                <div className="relative shrink-0 w-full" data-name="Container">
                  <div className="content-stretch flex gap-[24px] items-start relative w-full">
                    <div className="bg-[#fff0f8] relative rounded-[16px] shrink-0 size-[128px]" data-name="Link">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
                        <div className="bg-[#f3f4f6] h-[128px] relative shrink-0 w-full" data-name="At">
                          <div className="flex flex-row items-center justify-center size-full">
                            <div className="content-stretch flex items-center justify-center px-[20px] relative size-full">
                              <div className="relative shrink-0 size-[128px]" data-name="Screenshot 2026-03-18 011238 2">
                                <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none">
                                  <img alt="" className="absolute h-[113%] left-[-3.46%] max-w-none top-[-4.14%] w-[107.16%]" src={imgScreenshot202603180112382} />
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="flex-[705.063_0_0] h-[128px] min-h-px min-w-px relative" data-name="Container">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start relative size-full">
                        <div className="content-stretch flex h-[47.987px] items-start justify-between relative shrink-0 w-full" data-name="Container">
                          <div className="h-[47.987px] relative shrink-0 w-[152.637px]" data-name="Container">
                            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-start relative size-full">
                              <div className="content-stretch flex h-[15.988px] items-start relative shrink-0 w-full" data-name="Paragraph">
                                <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16px] min-h-px min-w-px relative text-[#ff1a75] text-[12px]">Issy</p>
                              </div>
                              <div className="h-[28px] relative shrink-0 w-full" data-name="Heading 3">
                                <p className="absolute font-['Playfair_Display:SemiBold',sans-serif] font-semibold leading-[27px] left-0 text-[#2d2d2d] text-[18px] top-[-0.4px] whitespace-nowrap">Active Foundation</p>
                              </div>
                            </div>
                          </div>
                          <div className="h-[47.987px] relative rounded-[12px] shrink-0 w-[36px]" data-name="Button">
                            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[13.987px] px-[8px] relative size-full">
                                ...
                                <div className="absolute bottom-[8.33%] left-[20.83%] right-[20.83%] top-1/4" data-name="Vector">
                                  <div className="absolute inset-[-6.25%_-7.14%]">
                                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3333 15">
                                      <path d={svgPaths.p35bdd700} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                                    </svg>
                                  </div>
                                </div>
                                <div className="absolute bottom-3/4 left-[33.33%] right-[33.33%] top-[8.33%]" data-name="Vector">
                                  <div className="absolute inset-[-25%_-12.5%]">
                                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.33333 5">
                                      <path d={svgPaths.p18bd6f80} id="Vector" stroke="var(--stroke-0, #99A1AF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                                    </svg>
                                  </div>
                                </div>
                                <IconVectorBackgroundImage additionalClassNames="inset-[45.83%_58.33%_29.17%_41.67%]" />
                                <IconVectorBackgroundImage additionalClassNames="inset-[45.83%_41.67%_29.17%_58.33%]" />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="content-stretch flex h-[51.987px] items-end justify-between relative shrink-0 w-full" data-name="Container">
                          <div className="h-[43.2px] relative rounded-[26843500px] shrink-0 w-[133.2px]" data-name="Container">
                            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip p-[1.6px] relative rounded-[inherit] size-full">
                              <ButtonBackgroundImage>
                                <div className="h-[16px] overflow-clip relative shrink-0 w-full" data-name="Icon">
                                  <VectorBackgroundImage />
                                </div>
                              </ButtonBackgroundImage>
                              <BackgroundImage2 additionalClassNames="h-[40px] w-[50px]">
                                <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] left-[25.36px] text-[#2d2d2d] text-[16px] text-center top-[7.6px] whitespace-nowrap">1</p>
                              </BackgroundImage2>
                              <ButtonBackgroundImage>
                                <div className="h-[16px] overflow-clip relative shrink-0 w-full" data-name="Icon">
                                  <VectorBackgroundImage />
                                  <div className="absolute bottom-[20.83%] left-1/2 right-1/2 top-[20.83%]" data-name="Vector">
                                    <div className="absolute inset-[-7.14%_-0.67px]">
                                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.33333 10.6667">
                                        <path d="M0.666667 0.666667V10" id="Vector" stroke="var(--stroke-0, #FF1A75)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                                      </svg>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <BackgroundImage2 additionalClassNames="h-[51.987px] w-[79.738px]">
                            <div className="absolute content-stretch flex flex-col items-end left-[-23.53px] top-[-0.19px] w-[104px]">
                              <div className="content-stretch flex h-[32px] items-start relative shrink-0 w-full" data-name="Paragraph">
                                <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[32px] relative shrink-0 text-[#ff1a75] text-[24px] text-right whitespace-nowrap">₱699.00</p>
                              </div>
                              <div className="h-[20px] relative shrink-0 w-[79.738px]" data-name="Paragraph">
                                <p className="-translate-x-full absolute font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[20px] left-[80px] text-[#4a5565] text-[14px] text-right top-[-0.2px] whitespace-nowrap">₱699 each</p>
                              </div>
                            </div>
                          </BackgroundImage2>
                        </div>
              ...
              <div className="absolute h-[508.788px] left-[938.66px] top-0 w-[437.337px]" data-name="Container" />
            </div>
          </div>
        </div>
      </div>
      <div className="absolute left-0 size-0 top-[730.4px]" data-name="Grammarly-desktop-integration" />
      <div className="absolute bg-white border-[0.8px] border-[rgba(255,102,178,0.2)] border-solid h-[508.788px] left-[1007px] rounded-[16px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[270px] w-[437.337px]" data-name="Dd">
        <div className="absolute content-stretch flex h-[31.988px] items-start left-[32px] top-[32px] w-[371.738px]" data-name="Heading 2">
          <p className="flex-[1_0_0] font-['Playfair_Display:Bold',sans-serif] font-bold leading-[32px] min-h-px min-w-px relative text-[#2d2d2d] text-[24px]">Order Summary</p>
        </div>
        <div className="absolute content-stretch flex flex-col gap-[16px] h-[202.4px] items-start left-[32px] top-[87.99px] w-[371.738px]" data-name="Container">
          <ContainerBackgroundImage>
            <TextBackgroundImageAndText text="Subtotal (1 items)" additionalClassNames="w-[127.988px]" />
            <BackgroundImage2 additionalClassNames="h-[24px] w-[52.3px]">
              <p className="absolute font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] left-[11.7px] text-[#364153] text-[16px] top-[-0.4px] whitespace-nowrap">₱699</p>
            </BackgroundImage2>
          </ContainerBackgroundImage>
          <ContainerBackgroundImage>
            <TextBackgroundImageAndText text="Shipping Fee" additionalClassNames="w-[99.313px]" />
            <BackgroundImage2 additionalClassNames="h-[24px] w-[39.538px]">
          ...
          <div className="bg-[#fff8c3] h-[52px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
            <div className="content-stretch flex flex-col items-start pt-[16px] px-[16px] relative size-full">
              <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
                <p className="absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[20px] left-0 text-[#ff1a75] text-[14px] top-[-0.2px] whitespace-nowrap">Add ₱801 more to get FREE shipping!</p>
              </div>
            </div>
          </div>
          <div className="content-stretch flex flex-col h-[54.4px] items-start pt-[17.6px] relative shrink-0 w-full" data-name="Container">
            ...
            <div className="h-[36.8px] relative shrink-0 w-full" data-name="Container">
              <div className="absolute h-[28px] left-0 top-[8.8px] w-[46.563px]" data-name="Text">
              ...
              <div className="absolute h-[36px] left-[269.07px] top-0 w-[102.662px]" data-name="Text">
                <p className="absolute font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[36px] left-[23.06px] text-[#ff1a75] text-[30px] top-[0.2px] whitespace-nowrap">₱849</p>
              </div>
            </div>
          </div>
        </div>
        <div className="absolute bg-[#ff1a75] h-[56px] left-[32px] rounded-[26843500px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[314.39px] w-[371.738px]" data-name="Button">
          <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] left-[172.11px] text-[16px] text-center text-white top-[15.6px] whitespace-nowrap">Proceed to Checkout</p>
          <IconBackgroundImage additionalClassNames="absolute left-[262.63px] top-[18px]">
        ...
        <div className="absolute h-[20px] left-[32px] top-[386.39px] w-[371.738px]" data-name="Link">
          <p className="-translate-x-1/2 absolute font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[20px] left-[185.92px] text-[#ff1a75] text-[14px] text-center top-[-0.2px] whitespace-nowrap">Continue Shopping</p>
        </div>
        <div className="absolute content-stretch flex flex-col h-[44.8px] items-start left-[32px] pt-[24.8px] top-[430.39px] w-[371.738px]" data-name="Container">
          ...
          <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
            <div className="flex flex-row items-center justify-center size-full">
              <div className="content-stretch flex gap-[8px] items-center justify-center pl-[113.9px] pr-[113.912px] relative size-full">
                <IconBackgroundImage additionalClassNames="relative shrink-0">
                  <path clipRule="evenodd" d={svgPaths.p22929a00} fill="var(--fill-0, #E4550C)" fillRule="evenodd" id="Vector" />
                </IconBackgroundImage>
                <BackgroundImageAndText text="Secure Checkout" additionalClassNames="w-[115.925px]" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="absolute content-stretch flex gap-[8px] h-[36px] items-center left-0 top-[2px] w-[140.3px]" data-name="Container">
              <div className="h-[36px] relative rounded-[26843500px] shrink-0 w-[96.3px]" data-name="Link">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center pl-[16px] relative size-full">
                  ...
                  <BackgroundImage2 additionalClassNames="h-[20px] w-[36.3px]">
              ...
              <div className="col-4 content-stretch flex flex-col gap-[16px] items-start justify-self-stretch relative row-1 self-stretch shrink-0" data-name="Container">
                ...
                <div className="content-stretch flex flex-col gap-[12px] h-[104px] items-start relative shrink-0 w-full" data-name="List">
                  ...
                  <div className="content-stretch flex gap-[8px] h-[20px] items-center relative shrink-0 w-full" data-name="List Item">
                    ...
                    <BackgroundImageAndText text="+63 900 123 4567" additionalClassNames="w-[116.888px]" />
                  </div>
                  <div className="content-stretch flex gap-[8px] h-[20px] items-center relative shrink-0 w-full" data-name="List Item">
                    <IconBackgroundImage additionalClassNames="relative shrink-0">
                    ...
                    <BackgroundImageAndText text="support@mariqits.com" additionalClassNames="w-[154.213px]" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center justify-between relative size-full">
                    <BackgroundImageAndText text="© 2026 Mariqits Beauty E-Commerce. All rights reserved." additionalClassNames="w-[375.962px]" />
                    <div className="h-[20px] relative shrink-0 w-[330.4px]" data-name="Container">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[24px] items-start relative size-full">
                        <BackgroundImageAndText text="Privacy Policy" additionalClassNames="w-[90.4px]" />
                        <BackgroundImageAndText text="Terms of Service" additionalClassNames="w-[108.363px]" />
                        <BackgroundImageAndText text="Admin Portal" additionalClassNames="w-[83.638px]" />
                      </div>
                    </div>
                  </div>
                </div>
